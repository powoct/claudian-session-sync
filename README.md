...
```bash
npm ci
npm run verify   # typecheck, lint, secret/docs gates, ~975 tests, build, bundle checks
```
...
Every behavioural claim above traces to a decision record (ADR 1–61) and, where it
